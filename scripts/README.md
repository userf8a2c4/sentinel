...
- `post_to_x.py`: publica alertas técnicas en X (Twitter).
...
3. Ejecutar `post_to_x.py` para difundir resultados.
...
- `post_to_x.py`: publishes technical alerts to X (Twitter).
...
3. Run `post_to_x.py` to publish results.
