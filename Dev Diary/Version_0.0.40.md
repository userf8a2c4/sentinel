# Integración Mayor → main – Consolidación y Refactor 2026

/dev: Notas del parche: Versión: v0.0.40 (integración principal)
...
- Múltiples merges y limpiezas de ramas antiguas (`dev-v3` → `main`)
...
Major merge into `main`: +150 commits including full code refactor to src/ layout, new Command Center, modular analysis package, reorganized anomaly rules and preparation for frontend integration. Adopts the updated AGPL-3.0 LICENSE from main (commit Jan 15, 2026).
